package io.github.lancevalour.android.verticalstepper.app;
...
import io.github.lancevalour.android.verticalstepper.VerticalStepperFormLayout;
import io.github.lancevalour.android.verticalstepper.fragments.BackConfirmationFragment;
...
public class NewAlarmFormActivity extends AppCompatActivity implements VerticalStepperForm {
    ...
    private void initializeActivity() {
        ...
        VerticalStepperFormLayout.Builder.newInstance(
                verticalStepperForm, stepsTitles, this, this)
    ...
    private void activateDay(int index, LinearLayout dayLayout, boolean check) {
        ...
        Drawable bg = ContextCompat.getDrawable(getBaseContext(),
                io.github.lancevalour.android.verticalstepper.R.drawable.circle_step_done);
        int colorPrimary = ContextCompat.getColor(getApplicationContext(), R.color.colorPrimary);
